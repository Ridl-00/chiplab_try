...
#                script (type 'data_bank_sram.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.data_bank_sram xil_defaultlib.glbl -o data_bank_sram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./data_bank_sram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key data_bank_sram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc data_bank_sram_simv.daidir vcs_lib c.obj)
