...
#
# Script generated by Vivado on Sun Mar 02 15:26:54 +0800 2025
...
#
# Usage        : axi_ram.sh
#                axi_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_ram.sh [-reset_run]
#                axi_ram.sh [-reset_log]
#                axi_ram.sh [-help]
#
...
# script info
echo -e "axi_ram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_ram xil_defaultlib.axi_ram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_ram -key {Behavioral:sim_1:Functional:axi_ram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_ram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_ram.sh [-help]\n\
Usage: axi_ram.sh [-step]\n\
Usage: axi_ram.sh [-lib_map_path]\n\
Usage: axi_ram.sh [-reset_run]\n\
Usage: axi_ram.sh [-reset_log]\n\
Usage: axi_ram.sh [-keep_index]\n\
Usage: axi_ram.sh [-noclean_files]\n\n\
