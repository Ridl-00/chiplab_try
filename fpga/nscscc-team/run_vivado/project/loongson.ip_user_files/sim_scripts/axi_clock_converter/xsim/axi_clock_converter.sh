...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_infrastructure_v1_1_0 -L fifo_generator_v13_2_9 -L axi_clock_converter_v2_1_28 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_clock_converter xil_defaultlib.axi_clock_converter xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_clock_converter -key {Behavioral:sim_1:Functional:axi_clock_converter} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_clock_converter.wdb xsim.dir libdpi.so)
