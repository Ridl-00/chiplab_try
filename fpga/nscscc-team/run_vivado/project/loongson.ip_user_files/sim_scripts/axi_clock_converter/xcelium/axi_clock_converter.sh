...
#
# Script generated by Vivado on Sun Mar 02 15:31:03 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_clock_converter.sh
...
#
# Usage        : axi_clock_converter.sh
#                axi_clock_converter.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_clock_converter.sh [-reset_run]
#                axi_clock_converter.sh [-reset_log]
#                axi_clock_converter.sh [-help]
#
...
#                script (type 'axi_clock_converter.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axi_infrastructure_v1_1_0 -libname fifo_generator_v13_2_9 -libname axi_clock_converter_v2_1_28 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axi_infrastructure_v1_1_0 fifo_generator_v13_2_9 axi_clock_converter_v2_1_28 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_clock_converter.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_clock_converter.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_clock_converter/gen/hdl" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_clock_converter/gen/hdl" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_clock_converter/gen/hdl" \
  ...
  xmvlog -work axi_clock_converter_v2_1_28 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_clock_converter/gen/hdl" \
  "../../../ipstatic/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_clock_converter/gen/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_clock_converter xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_clock_converter -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_clock_converter_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_clock_converter.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_clock_converter.sh [-help]\n\
Usage: axi_clock_converter.sh [-step]\n\
Usage: axi_clock_converter.sh [-lib_map_path]\n\
Usage: axi_clock_converter.sh [-reset_run]\n\
Usage: axi_clock_converter.sh [-reset_log]\n\
Usage: axi_clock_converter.sh [-keep_index]\n\
Usage: axi_clock_converter.sh [-noclean_files]\n\n\
