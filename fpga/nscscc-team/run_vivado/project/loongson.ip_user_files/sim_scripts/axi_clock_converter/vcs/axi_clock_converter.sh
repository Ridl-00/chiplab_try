...
design_libs=(xpm axi_infrastructure_v1_1_0 fifo_generator_v13_2_9 axi_clock_converter_v2_1_28 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_clock_converter/gen/hdl" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_clock_converter/gen/hdl" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_9 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_clock_converter/gen/hdl" \
  ...
  vlogan -work axi_clock_converter_v2_1_28 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_clock_converter/gen/hdl" \
  "../../../ipstatic/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_clock_converter/gen/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_clock_converter xil_defaultlib.glbl -o axi_clock_converter_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_clock_converter_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_clock_converter_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_clock_converter_simv.daidir vcs_lib c.obj)
