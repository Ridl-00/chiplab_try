...
#
# Script generated by Vivado on Sun Mar 02 15:30:58 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_crossbar_2x3.sh
...
#
# Usage        : axi_crossbar_2x3.sh
#                axi_crossbar_2x3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_crossbar_2x3.sh [-reset_run]
#                axi_crossbar_2x3.sh [-reset_log]
#                axi_crossbar_2x3.sh [-help]
#
...
#                script (type 'axi_crossbar_2x3.sh -help' for more information).
#
...
# script info
echo -e "axi_crossbar_2x3.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_crossbar_2x3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_crossbar_2x3/gen/hdl" \
  ...
  vlogan -work generic_baseblocks_v2_1_1 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_crossbar_2x3/gen/hdl" \
  "../../../ipstatic/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_crossbar_2x3/gen/hdl" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_29 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_crossbar_2x3/gen/hdl" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_9 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_crossbar_2x3/gen/hdl" \
  ...
  vlogan -work axi_data_fifo_v2_1_28 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_crossbar_2x3/gen/hdl" \
  "../../../ipstatic/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_30 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_crossbar_2x3/gen/hdl" \
  "../../../ipstatic/hdl/axi_crossbar_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/axi_crossbar_2x3/gen/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_crossbar_2x3 xil_defaultlib.glbl -o axi_crossbar_2x3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_crossbar_2x3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_crossbar_2x3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_crossbar_2x3_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_crossbar_2x3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_crossbar_2x3.sh [-help]\n\
Usage: axi_crossbar_2x3.sh [-step]\n\
Usage: axi_crossbar_2x3.sh [-lib_map_path]\n\
Usage: axi_crossbar_2x3.sh [-reset_run]\n\
Usage: axi_crossbar_2x3.sh [-reset_log]\n\
Usage: axi_crossbar_2x3.sh [-keep_index]\n\
Usage: axi_crossbar_2x3.sh [-noclean_files]\n\n\
