...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/clk_pll/gen" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic" +incdir+"../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/clk_pll/gen" \
