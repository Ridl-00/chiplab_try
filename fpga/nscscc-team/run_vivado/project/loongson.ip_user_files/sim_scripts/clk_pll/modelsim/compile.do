...
vlog -work xpm  -incr -mfcu  -sv "+incdir+../../../ipstatic" "+incdir+../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/clk_pll/gen" \
...
vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../ipstatic" "+incdir+../../../../../../../../chip/soc_demo/nscscc-team/xilinx_ip/clk_pll/gen" \
