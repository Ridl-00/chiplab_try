...
#                script (type 'tagv_sram.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tagv_sram xil_defaultlib.glbl -o tagv_sram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tagv_sram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tagv_sram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tagv_sram_simv.daidir vcs_lib c.obj)
