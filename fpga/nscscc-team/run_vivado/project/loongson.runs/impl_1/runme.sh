...
HD_PWD='E:/projects_2024/Loong_Team/chiplab_try/fpga/nscscc-team/run_vivado/project/loongson.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_axi_lite_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soc_axi_lite_top.tcl -notrace
