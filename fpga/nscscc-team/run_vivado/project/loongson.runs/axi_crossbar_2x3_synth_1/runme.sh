...
HD_PWD='e:/projects_2024/Loong_Team/chiplab/fpga/nscscc-team/run_vivado/project/loongson.runs/axi_crossbar_2x3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_crossbar_2x3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_crossbar_2x3.tcl
