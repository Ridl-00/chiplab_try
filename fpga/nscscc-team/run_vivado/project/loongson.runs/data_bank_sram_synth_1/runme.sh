...
HD_PWD='E:/projects_2024/Loong_Team/chiplab_try/fpga/nscscc-team/run_vivado/project/loongson.runs/data_bank_sram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_bank_sram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_bank_sram.tcl
